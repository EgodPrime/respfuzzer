...
from mplfuzz.agentic_api_resolver import solve, API, ExecutionResultType
import ast
...
def test_solve_retry_with_reasoner(mock_explain, mock_execute, mock_generate):
    ...
    mock_execute.side_effect = [
        {"result_type": ExecutionResultType.ABNORMAL, "ret_code": 1, "stdout": "", "stderr": "ValueError: malformed node"},
