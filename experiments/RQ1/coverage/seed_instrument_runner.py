...
try:
    from instrument import instrument_function_via_path_check_ctx, instrument_function_fcr
...
def main() -> None:
    ...
    p.add_argument('--apis-json', required=True, help='Path to JSON file listing APIs to instrument')
    p.add_argument('--cwd', help='Working directory to chdir into before executing the seed')
    args = p.parse_args()
